...
This example Python project shows how to create a basic terminal-based chatbot to interact with an LLM deployed to Azure AI Foundry and running with the Azure AI Inference API, with all interactions logged to Galileo. You can use this to:
