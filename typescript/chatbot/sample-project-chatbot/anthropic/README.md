# Basic Chatbot Example - TypeScript/Anthropic

This example TypeScript project shows how to create a basic terminal-based chatbot to interact with an Anthropic LLM, with all interactions logged to Galileo.
